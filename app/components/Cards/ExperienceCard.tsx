...
export default function ExperienceCard({ title, company, period, description }: experienceInterface) {
  return (
    <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
      <div className="flex justify-between items-start mb-4 items-center">
        <div>
          ...
          <p className="text-lg text-blue-600 dark:text-blue-400">{company}</p>
        </div>
